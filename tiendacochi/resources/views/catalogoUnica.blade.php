    ...
    <form action="pedido" method="POST">    
        ...
        <div class="row">
            <div class="col-sm-8 mx-auto" style="padding-left: 4rem; padding-right: 4rem;">
                <h6 class="text-center" style="color: #af3636">NOMBRE</h6>
                <input id="text" type="text" class="form-control mb-3 register" placeholder="Juan Perez" name="user"
        ...
        <div class="row">
            <div class="col-sm-8 mx-auto" style="padding-left: 4rem; padding-right: 4rem;">
                <h6 class="text-center" style="color: #af3636">MAIL</h6>
                    <input id="email" type="email" class="form-control mb-3 register @error('email') is-invalid @enderror" name="email"
        ...
        <div class="row">
            <div class="col-sm-8 mx-auto" style="padding-left: 4rem; padding-right: 4rem;">
                <h6 class="text-center"style="color: #af3636">TELEFONO</h6>
                <input id="telContacto" type="text" class="form-control mb-3 email-login" placeholder="(261)2128105" name="telContacto"
        ...
        <div class="row g-3">
            <div class="col">
                <h5><input class="form-check-input" type="checkbox" name="retiroBodega" id="retiroBodega" 
                value="retiroBodega" onchange="javascript:showContent()"><b> Retiro en bodega</b></h5>
            </div>
        </div>
</div>
