...
<div class="container pl-3 mt-5">
    <form action="pedido" method="POST">
        ...
        <div class="row">
            <div class="col-sm-8 mx-auto" style="padding-left: 4rem; padding-right: 4rem;">
                <h6 class="text-center" style="color: ##ff5765">NOMBRE</h6>
                <input id="text" type="text" class="form-control mb-3 register" placeholder="Juan Perez"
                    name="user" value="{{ old('text') }}" required autocomplete="text">
                <input type="hidden" name="dto" value="{{ $dto }}">
            </div>
        </div>
        <div class="row">
            <div class="col-sm-8 mx-auto" style="padding-left: 4rem; padding-right: 4rem;">
                <h6 class="text-center" style="color: ##ff5765">MAIL</h6>
                <input id="email" type="email"
                    class="form-control mb-3 register @error('email') is-invalid @enderror" name="email"
                    value="{{ old('email') }}" required autocomplete="email" placeholder="juan@gmail.com">
                @error('email')
        ...
        <div class="row">
            <div class="col-sm-8 mx-auto" style="padding-left: 4rem; padding-right: 4rem;">
                <h6 class="text-center"style="color: ##ff5765">TELEFONO</h6>
                <input id="telContacto" type="text" class="form-control mb-3 email-login" placeholder="(261)2128105"
                    name="telContacto" value="{{ old('telContacto') }}" required autocomplete="telContacto">
            </div>
        </div>
        <div class="row">
...
<div class="d-grid gap-2">
    <button type="submit" class="btn btn-danger m-5" id="pedir" style="border-radius:50px; background: ##ff5765;"
        disabled>PEDIR</a>
</div>
</form>
</div>
